import { Heart, Moon, Apple, Brain, Baby, Shield, BookOpen } from "lucide-react";
...
const articles = [
  { title: "La diversification alimentaire mois par mois", category: "Nutrition", readTime: "5 min", author: "Dr. Sophie Martin, Pédiatre", isNew: true },
  { title: "Le sommeil de bébé à 8 mois : ce qui change", category: "Sommeil", readTime: "4 min", author: "Claire Dubois, Sage-femme", isNew: true },
  { title: "Quand bébé se met debout : les étapes clés", category: "Développement", readTime: "3 min", author: "Dr. Pierre Leroy, Pédiatre", isNew: false },
  { title: "Les bons réflexes en cas de fièvre", category: "Santé", readTime: "6 min", author: "Dr. Nathalie Vidal, Urgentiste", isNew: false },
  { title: "Stimuler le langage de votre enfant", category: "Éveil", readTime: "4 min", author: "Marie Fabre, Orthophoniste", isNew: false },
  { title: "Allergie alimentaire : signes d'alerte", category: "Santé", readTime: "5 min", author: "Dr. Sophie Martin, Pédiatre", isNew: true },
];
    ...
    <div className="px-4 pt-6 pb-4 space-y-5">
      ...
      <div className="space-y-3">
        {filtered.map((article, i) => (
          <div key={i} className="medical-card space-y-2 cursor-pointer hover:scale-[1.01] transition-transform animate-fade-in" style={{ animationDelay: `${i * 50}ms` }}>
